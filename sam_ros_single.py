...
class ImageSubscriber(Node):
    def __init__(self):
        ...
        self.mask_pub = self.create_publisher(Image, '/clever/mask', 10)
        self.masked_frame_pub = self.create_publisher(Image, '/clever/masked_frame', 10)
    ...
    def sam_tracking(self, cv_image):
        with torch.cuda.amp.autocast():
            ...
            if point_id == 0:
                ...
                # cv2.floodFill(pred_mask, single_mask, self.points[0], 1, (0,), (0,), flags=cv2.FLOODFILL_MASK_ONLY)
            ...
            pred_mask = np.where(pred_mask != 0, pred_mask + self.obj_ids - 1, pred_mask)
